<div class="flex justify-between mb-[20px]">
    <h3 class="text-sm text-txtgray font-semibold">INV-26773</h3>
    <div class="text-xs text-txtgray">10 Januari 2024</div>
</div>
<div class="flex justify-between mb-[20px]">
    <div class="space-y-[40px]">
        <div class="flex justify-start space-x-[87px] mt-7">
            <div>
                <p class="text-[11px] text-txtgray">Kepada:</p>
                <div class="text-lg font-semibold text-klinikBlue">Esther Howard</div>
                <div class="text-[11px] font-semibold text-txtgray">0812182930100</div>
            </div>
            <div>
                <p class="text-[11px] text-txtgray">Pasien:</p>
                <div class="text-lg font-semibold text-klinikBlue">Blacky</div>
                <div class="text-[11px] font-semibold text-txtgray">Anjing</div>
                <div class="text-[11px] font-semibold text-txtgray">No. RM : 2</div>
            </div>
        </div>
        
        <div class="relative overflow-x-auto">
            <p class="text-[11px] font-medium text-txtgray ps-6">List Pembayaran</p>
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs bg-white border-b text-txtgray">
                    <tr>
        ...
        <div>
            <p class="text-txtgray text-[11px]">Catatan Dokter:</p>
            <div class="font-semibold text-xs text-txtgray">Gratis pemeriksaan dan potongan 20%</div>
        </div>
    </div>
    ...
    <!-- form -->
     <div class="ms-[18px]">
         ...
         <!-- Metode Pembayaran -->
       <div class="bg-klinikBlue space-y-8 text-white px-7 py-6 rounded-lg w-[452px]">
         <div>
             ...
             <div class="space-y-2">
              ...
              <label class="flex items-center border border-white p-4 rounded-lg cursor-pointer h-[45px]">
                  <input class="form-radio text-white hover:text-[#252F4A] hover:bg-[#252F4A]" name="payment" type="radio"/>
                  <span class="ml-4 flex items-center">
              <svg width="30" height="20" class="me-3" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.5 0.416138H29.8848V20.006H0.5V0.416138ZM15.1924 5.3136C16.4913 5.3136 17.737 5.82958 18.6554 6.74803C19.5739 7.66648 20.0898 8.91217 20.0898 10.2111C20.0898 11.5099 19.5739 12.7556 18.6554 13.6741C17.737 14.5925 16.4913 15.1085 15.1924 15.1085C13.8935 15.1085 12.6478 14.5925 11.7294 13.6741C10.8109 12.7556 10.2949 11.5099 10.2949 10.2111C10.2949 8.91217 10.8109 7.66648 11.7294 6.74803C12.6478 5.82958 13.8935 5.3136 15.1924 5.3136ZM7.02995 3.68111C7.02995 4.54704 6.68596 5.37749 6.07366 5.9898C5.46136 6.6021 4.6309 6.94609 3.76497 6.94609V13.476C4.6309 13.476 5.46136 13.82 6.07366 14.4323C6.68596 15.0446 7.02995 15.8751 7.02995 16.741H23.3548C23.3548 15.8751 23.6988 15.0446 24.3111 14.4323C24.9234 13.82 25.7539 13.476 26.6198 13.476V6.94609C25.7539 6.94609 24.9234 6.6021 24.3111 5.9898C23.6988 5.37749 23.3548 4.54704 23.3548 3.68111H7.02995Z" fill="currentColor"/>
              </svg>
                Cash
               </span>
              </label>
        ...
        <div>
            ...
            <div class="flex justify-between items-baseline">
                 <label>
                     ...
                     <input class="w-full p-2 rounded-lg text-[8px] h-[20px] bg-white text-txtgray placeholder-gray-400" placeholder="cth : 30" type="text"/>
                 </label>
                 <label>
                     <input class="form-radio text-black" name="discount" type="radio"/>
                     <span class="ml-2 text-[12.43px]">
