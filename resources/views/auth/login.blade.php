...
@csrf
    ...
    <div class="flex justify-end mt-4">
        <a class="text-sm text-klinikBlue hover:underline rounded-md focus:outline-none" href="{{ route('forgot') }}">
            Forgot password?
        </a>
    </div>

    <div>
        <button type="submit" class="bg-[#1B84FF] flex w-full h-[40px] items-center justify-center rounded-md text-[13px] leading-6 text-white shadow-sm">
            Masuk 
