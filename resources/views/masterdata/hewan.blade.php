                    ...
                    <tbody>
                        @foreach ($hewan as $index => $item)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 font-semibold border-r border-gray-100 ">{{ $item->jenis_hewan }}</td>
                                <td class="px-6 py-4 border-r border-gray-100 ">{{ $item->pulsus }}</td>
                                <td class="px-6 py-4 border-r border-gray-100 ">{{ $item->suhu }}</td>
                                <td class="px-6 py-4 border-r border-gray-100 ">{{ $item->frekuensi_napas }}</td>
