...
<div class="overflow-x-auto mt-5 bg-white rounded-lg shadow-md">
    <x-table :table="$diagnosa" id="dataTable">
        <x-custom-thead>
            <tr>
                <th scope="col" class="px-6 py-3 text-center max-w-2 border-r border-gray-100"
        ...
        @foreach ($diagnosa as $index => $item)
            <tr class="bg-white border-b">
                <td class="px-6 py-2 text-center font-semibold border-r border-gray-100">
