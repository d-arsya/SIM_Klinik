...
@section('content')
    <div class="flex items-center justify-between px-8">
        <h1 class="font-bold">Tabel Diagnosa Pasien</h1>
        <div class="flex">
            <a href="{{ route('masterdata.diagnosa.create') }}"
                        ...
                        @foreach ($diagnosa as $index => $item)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 font-semibold text-center border-r border-gray-100">
                                    {{ $item->id_diagnosa }}</td>
                                <td class="px-6 py-4 font-semibold border-r border-gray-100 ">{{ $item->hasil_diagnosa }}</td>
                                <td class="px-6 py-4 border-r border-gray-100 ">{{ $item->hewan ? $item->hewan->jenis_hewan : 'Tidak ada data' }}</td>
