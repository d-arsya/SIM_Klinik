...
<div class="mt-[30px] border-2 rounded-xl">
    ...
    <form id="submitForm" class="p-[30px]" action="{{ route('owner.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid items-center w-full grid-cols-7 gap-4 mb-4">
            ...
            <x-label for="spesialis">Spesialis</x-label>
            <input type="text" name="spesialis" placeholder="Dokter Anjing" class="col-span-6 mt-2 block w-full px-4 py-2 border rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
