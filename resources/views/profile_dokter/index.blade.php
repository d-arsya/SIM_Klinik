...
<div class="mt-[30px] border-2 rounded-xl">
    <div class="flex justify-between px-[30px] border-b-2">
        ...
        <x-link href="{{ route('dokter_edit_profile') }}" color="blue" class=" text-white px-4 h-[30px] self-center rounded-md">Edit</x-link>
    </div>
