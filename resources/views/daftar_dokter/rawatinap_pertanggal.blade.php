...
<div class="mb-7">
    <div class="flex justify-between items-center py-3">
        ...
        <x-link color="blue" href="{{ route('rawatinap_tambah_obat') }}"
            class="font-medium rounded-lg text-sm px-3 py-3 focus:outline-none">Tambah Obat</x-link>
    </div>
        <table class="w-fit text-left rtl:text-right">
            ...
            <tr>
                ...
                <th scope="col" class="items-center px-6 py-3 border-r border-gray-100"
 ...
 <div>
    <div class="flex justify-between items-center py-3">
        ...
        <x-button color="blue" type="submit"
            class="font-medium place-self-end rounded-lg text-sm px-3 py-3 focus:outline-none">Selesai Rawat Inap</x-button>
    </div>
</div> 
@endsection