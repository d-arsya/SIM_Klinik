...
<x-button color="red" type="submit"
    class="font-medium rounded-lg text-sm px-3 py-3 focus:outline-none">Batal</x-button>
<x-button color="blue" type="submit"
    class="font-medium rounded-lg text-sm px-3 py-3 focus:outline-none">Simpan</x-button>
</div>
@endsection